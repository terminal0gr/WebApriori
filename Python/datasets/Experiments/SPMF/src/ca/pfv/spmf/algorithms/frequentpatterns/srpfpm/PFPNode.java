...
public class PFPNode {
	...
	List<PFPNode> childs = new ArrayList<PFPNode>();

	PFPNode nodeLink = null; // link to next node with the same item id (for the header table).
	 ...
	 */
	PFPNode getChildWithID(int id) {
		// for each child node
		for(PFPNode child : childs){
