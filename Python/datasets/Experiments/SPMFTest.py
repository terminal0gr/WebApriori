...
# Run Apriori
os.system("java -jar spmf.jar run Apriori C:\xampp\htdocs\WebApriori\Python\datasets\Experiments\SPMF\datasets\contextPasquier99.txt C:\xampp\htdocs\WebApriori\Python\datasets\Experiments\SPMF\output.txt 40%")
