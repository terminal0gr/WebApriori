...
class qh_TopK_FIM:
    ...
    def getTopKFI(self, topKItemSets):
        # The procedure returns the dictionary of topK ItemSets with their support in descending order
    ...
    def mine(self):
        ...
        self.min_count, self.finalTopK = self.mineNextLevels(initialTopK)
