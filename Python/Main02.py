...
#sys.argv=["Main02.py", 'abcsef', 0.01, 0.02, 1.5, 4, -3, "supermarket.txt", ",", "3", '-1', "?", 'department1','department2','department3','department4','department5','department6','department7','department8','department9','grocery misc']


#sys.argv=["Main02.py", 'abcsef', 0.01, 0.2, 1.5, 4, -3, "titanic02WithoutHeader.csv", ",", "4", '-2']
#sys.argv=["Main02.py", 'abcsef', 0.01, 0.2, 1.5, 4, -3, "titanic02.csv", ",", "4", '1', "class", "age", "sex", "survived"]
